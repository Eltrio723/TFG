...
% 1 Información del Documento %
\newcommand{\tfgtitlename}{Desarrollo de un entorno virtual de juego para el entrenamiento cognitivo en personas mayores usando dispositivos de RV}
%\newcommand{\tfgtitlename}{Desarrollo }
\newcommand{\tfgtitlenameENG}{Virtual Reality in Brain Training}
\newcommand{\tfgsubtitlename}{Estudio de aplicación de un juego serio en realidad virtual para tratar el deterioro cognitivo leve}
\newcommand{\tfgauthorname}{Antonio Jiménez Amador}
\newcommand{\tfgtutornameA}{Francisco Luis Gutiérrez Vela}
\newcommand{\tfgtutornameB}{Patricia Paderewski Rodríguez}
\newcommand{\tfgmes}{Septiembre}
\newcommand{\tfganno}{2023}
